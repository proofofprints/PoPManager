      ...
      {discovered.length === 0 ? (
        <div className="text-center py-8">
          ...
          <p className="text-sm text-slate-400">
            No OverMiner devices found on your network.
          </p>
...
export default function PopMinerList() {
  ...
  const refresh = useCallback(async () => {
    try {
      ...
      console.error("Failed to load OverMiner devices:", err);
    } finally {
      setLoading(false);
    }
  }, []);
  ...
  return (
    <div className="p-8">
      ...
      <div className="mb-6 flex items-end justify-between">
        <div>
          <h2 className="text-2xl font-bold text-white">OverMiner Devices</h2>
          <p className="text-slate-400 mt-1">
            OverMiner hardware devices on your local network
          </p>
        </div>
      ...
      {loading ? (
        ...
        <div className="text-center py-20">
          ...
          <p className="text-lg font-medium text-slate-300">
            No OverMiner devices added
          </p>
          <p className="text-sm text-slate-500 mt-2 max-w-md mx-auto">
            Click "Add Device" above to discover OverMiner devices on your
            network. Make sure your OverMiner Nano (or other OverMiner device) is
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative z-10 bg-dark-800 border border-red-900/40 rounded-2xl p-6 w-full max-w-lg shadow-2xl">
            ...
            <div className="text-sm text-slate-300 space-y-3 mb-5">
              <p>
                Are you sure you want to remove this OverMiner device? It will no
