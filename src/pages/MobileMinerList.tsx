      ...
      {loading ? (
        ...
        <div className="text-center py-20">
          ...
          <p className="text-sm text-slate-500 mt-2 max-w-md mx-auto">
            Install OverMobile on your Android device and point it to this OverManager
            instance:
          </p>
          {serverUrl && (
          ...
          <div className="relative z-10 bg-dark-800 border border-red-900/40 rounded-2xl p-6 w-full max-w-lg shadow-2xl">
            ...
            <div className="text-sm text-slate-300 space-y-3 mb-5">
              ...
              <ol className="list-decimal list-inside space-y-1 text-slate-400">
                ...
                <li>Remove the device from OverManager's local registry</li>
              </ol>
              <p className="text-amber-400 text-xs border-l-2 border-amber-500/50 pl-3">
                ...
                If the device is still configured to report to this OverManager instance, it will re-register automatically
                on its next report. To permanently remove it, first change or clear the server URL in the OverMobile app.
              </p>
            </div>
            {removeError && (
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative z-10 bg-dark-800 border border-red-900/40 rounded-2xl p-6 w-full max-w-lg shadow-2xl">
            ...
            <div className="text-sm text-slate-300 space-y-3 mb-5">
              ...
              <p className="text-amber-400 text-xs border-l-2 border-amber-500/50 pl-3">
                <strong>Note:</strong> Cleanup commands are only delivered if each device is online. Devices still configured to report to this OverManager instance will re-register on their next report. To permanently remove them, first change or clear the server URL in each OverMobile app.
              </p>
            </div>
            {bulkRemoveError && (
              <div className="mb-4 px-3 py-2 bg-red-500/10 border border-red-500/30 rounded-lg text-xs text-red-400">
