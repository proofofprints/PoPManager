...
fn smtp_config_path() -> PathBuf {
    crate::paths::app_data_root().join("smtp_config.json")
}
...
pub async fn test_smtp_config() -> Result<String, String> {
    ...
    let email = Message::builder()
        ...
        .subject("OverManager Test Email")
        .header(ContentType::TEXT_PLAIN)
        .body("This is a test email from OverManager. Your alert notifications are configured correctly.".to_string())
        .map_err(|e| e.to_string())?;
